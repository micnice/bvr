...
<form method="POST">
    <div align="center"><h3>List of Vouchers by Beneficiary</h3><br /><table  style="background-color: #E0F277;">
        <tr>
        <tr>
...
SELECT serialno,purpose,firstname,surname,nationalid,dob,phone From beneficiarymaster,vouchers where serialno=idcoe and serialno=?;
   ...
   <td><c:out value="${row.phone}"/> </td>
    ...
    <c:if test="${exception!=null}">
        <font id="failureAlert">
            <br />Error Details: <c:out value="${exception}" />
        </font>
    </c:if>
</c:if>
</body>
