...
$sql = pg_query(
    $conn,
    "SELECT nationalid,firstname,surname,dob,sex,lmp,edd,guardian,maritalstatus,parity,location,village,postaladdress FROM beneficiarymaster where nationalid='$nationalid'"
);
...
if ($count == 0) {
  die(
      ...
      .$nationalid
      ."</em> does not exist! <br /><br /><a href='claimadd_form.php'>Try again!</a></div>"
  );
} else {
  ?>

    <form method="POST" action="claimadd_process.php" name="claimAdd">
        <div align="center"><h3>Enter Claims</h3><br/>
            <table style="background-color: #E0F277;">
                <tr>
                    <td><font size="4">Patient National ID:</font></td>
                    <td colspan="3"><?php echo "<font color='red'>$nationalid</font> <em>($firstname $surname)</em>"; ?>
                ...
                <tr>
                    ...
                    <td>
                        <select name="vouchertype" id="vouchertype" required>
                          ...
                          $sql = pg_query(
                              $conn,
                              "SELECT usage,shortname,price FROM vouchertype where usage=$vouchertype"
                          );
                          $count2 = 0;
                    ...
                    <td id="reasons"><?php
                      ...
                      if (in_array($vouchertype, $voucherReasons)) { ?>
                          <select name="reason" id="reason" required>
                            ...
                            $sql = pg_query(
                                $conn,
                                "SELECT idreason,shortname FROM reasons order by shortname"
                            );
                            while ($row = pg_fetch_assoc($sql)) {
                              echo '<option value="'.htmlspecialchars(
                                      $row['idreason']
                          ...
                          <input name="other" value="yes" type="checkbox"
                                 onclick="enable_other(this.checked)">
                      <?php } ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><select name="distributor" id="distributor">
                        ...
                        $sql = pg_query(
                            $conn,
                            "SELECT idfacility,facilityname FROM facility where idfacility=$distributor"
                        );
                    ...
                    <td>Voucher Serial:<br/><input type="number" size="6"
                                                   maxlength="10"
                                                   name="voucherserial"
                                                   value="<?php echo $redeemserial; ?>"
                                                   required></td>
                    <td>Claim Form Serial:<br/><input type="number" size="6"
                                                      maxlength="10"
                                                      name="claimserial"
                                                      value="<?php echo $claimserial; ?>">
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="claimdate"
                               value="<?php echo date('d/m/Y'); ?>"
                               pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}"
                               placeholder="d/m/Y" required></td>
                </tr>
                <tr class="lime">
                    <td><font size="4">Surname</font></td>
                    <td><input type="text" size="30" maxlength="50"
                               name="surname"
                               value="<?php echo trim($surname); ?>" required>
                    </td>
                    <td><font size="4">Other Names</font></td>
                    <td><input type="text" size="40" maxlength="40"
                               name="firstname"
                               value="<?php echo trim($firstname); ?>" required>
                    </td>
                </tr>
                <tr class="lime">
                    <td><font size="4">DOB:</font><input type="text" size="11"
                                                         maxlength="11"
                                                         name="dob" id="dob"
                                                         value="<?php echo trim(
                                                             $dob
                        ...
                        Age:<input type="text" id="age" value="" size="6"
                                   onblur="getDob()"><input id="checkage"
                                                            type="checkbox"
                                                            onclick="enableAge()">
                    </td>
                    ...
                    <td><font size="4">LMP:</font><input type="text" size="11"
                                                         maxlength="11"
                                                         name="lmp"
                                                         value="<?php echo trim(
                                                             $lmp
                                                         ...
                                                         placeholder="dd/mm/yyyy"
                                                         onblur="getEdd()"></td>
                    <td><font size="4">EDD:</font> <input type="hidden"
                                                          size="11"
                                                          maxlength="11"
                                                          value="" name="edd"
                                                          id='edd'
                                ...
                                id="displayedd"><?php echo trim($edd); ?></span>
                    </td>
                </tr>
                <tr class="lime">
                    <td><font size="4">Guardian's Name for Minor
                            Patients:</font></td>
                    <td><input type="text" size="30" maxlength="50"
                               value="<?php echo $guardian; ?>" name="guardian">
                    </td>
                    <td><font size="4">Marital Status:</font></td>
                    <td><input type="text" size="40" maxlength="40"
                               value="<?php echo $maritalstatus; ?>"
                               name="maritalstatus"></td>
                </tr>
                <tr class="lime">
                ...
                <tr class="lime">
                    ...
                    <td><input type="text" size="40" maxlength="40"
                               value="<?php echo $village; ?>" name="village">
                    </td>
                </tr>
                <tr class="lime">
                    <td><font size="4">Postal Address:</font></td>
                    <td colspan="3"><input type="text" size="50" maxlength="50"
                                           value="<?php echo $postaladdress; ?>"
                                           name="postaladdress"></td>

                </tr>
                <tr>
                    <td><font size="4">Attendant's Name:</font></td>
                    <td><input type="text" size="30" maxlength="50" value=""
                               name="attendant"></td>
                    <td><font size="4">Profession:</font></td>
                    <td><input type="text" size="40" maxlength="40" value=""
                               name="profession"></td>
                </tr>
                <tr>
                    <td><font size="4">Service Offered</font></td>
                    <td><textarea rows="3" cols="30"
                                  value="<?php echo $vouchershortname; ?>"
                                  name="serviceoffered"><?php echo $vouchershortname; ?></textarea>
                    </td>
                    <td><font size="4">Required Follow Up</font></td>
                    <td><textarea rows="3" cols="30" value=""
                                  name="requiredfollowup"></textarea>
                    </td>
                </tr>
                <tr>
                    <td><font size="4">Service Charged</font></td>
                    <td><textarea rows="3" cols="30"
                                  value="<?php echo $voucherprice; ?>"
                                  name="servicecharged"><?php echo $voucherprice; ?></textarea>
                    </td>
