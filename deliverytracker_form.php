...
<div align="center"><h3>Track Deliveries</h3><br />
  <table  style="margin:auto auto;background-color: #E0F277;width: 400px; text-align: left">
        <tr>
            <td style="width: 200px"><font size="4">Expected Delivery Month</font></td>
            <td style="width: 200px"> <select name="period" id="period" required="true">
                <?php
                ...
                echo '<option value="'.htmlspecialchars($monthcode).'/'.htmlspecialchars($row['yearname']).'">'.htmlspecialchars($row['monthname'])." ".htmlspecialchars($row['yearname']).'</option>';}
                //pg_close($conn);
                ?>
                </select> 
            </td>
