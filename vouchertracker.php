...
<html>
    ...
    <body>
        ...
        if($filteron==0){
            $strSQL = "select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd from beneficiarymaster a,vouchersales b,facility c "
    ...
    <form action="vouchertracker.php" method="POST">
        ...
        <input type="submit" value="Search">
            ...
            for ($i = 0; $i < $numrows; $i++) {
                ...
                $redeemSQL = "select b.usage, b.shortname,'Redeemed' as status,facilityname,redeemdate,ref from redeemedvouchers a, vouchertype b, facility c where a.distributorno = c.idfacility and b.usage = a.vouchertype and redeemserial='$voucherserial' "
                        . " order by usage asc";
                ...
                for ($x = 0; $x < $numrowsRedeem; $x++) {
                    ...
                    if ($x == 0) {
                        ...
                        $bookdate = $splitRedeemDate[2].'-'.$splitRedeemDate[1].'-'.$splitRedeemDate[0];
                        ...
                        <tr style="vertical-align:top">
                            ...
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $lmp; ?> </nobr></td>
                            
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $redeemdate; ?></nobr></td>
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $newEdd; ?> </nobr></td>
            ...
            $voucherserial = $row["voucherserial"];
            $approvalSQL = "select approval from voucherclaims where voucherserial='$voucherserial'";
            ...
            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $rowRedeem["redeemdate"]; ?> </nobr></td>
