...
$strSQL
    = "select nationalid,min(idredeemedvouchers) idredeemedvouchers from redeemedvouchers group by nationalid";
echo $strSQL;
...
for ($i = 0; $i < $numrows; $i++) {
  ...
  $update_new
      = "update redeemedvouchers set newclient=1 where idredeemedvouchers='$idredeemed'";
