    ...
    <div align="center"><h3>Add Voucher Serial Numbers</h3><br/>
        <table style="background-color: #E0F277;">
            ...
            <tr>
                ...
                <td><input type="radio" name="redeemed" value="yes">Yes, <input
                            type="radio" name="redeemed" value="no">No
                </td>
            </tr>
        </table>
    </div>
...
<c:if test="${pageContext.request.method=='POST'}">
    <c:catch var="exception">
        <sql:update dataSource="${bvr}" var="updatedTable">
            ...
            (username,password,firstname,surname,organisation,userrole,location)
            values(?,?,?,?,?,?,?);
    ...
    <c:if test="${exception!=null}">
        <font id="failureAlert">
            Error! Unable to Save Data! <br/><br/>Error Details:
