...
$strSQL
    = "select a.nationalid,a.firstname,a.surname, a.lmp,a.location,a.village,a.phone,a.reg_date,a.city,"
...
<table>
    <tr style="background-image: url(images/green_bg.png);">
        ...
        <th>EDD</th>
        <th>
            <nobr>F112: Meals<br/> a day</nobr>
        </th>
        <th>
            <nobr>F113: Livelihood <br/>sources</nobr>
        </th>
        <th>
            <nobr>F114: Monthly <br/>remittances</nobr>
        </th>
        <th>
            <nobr>F115: % income <br/>(rent & rates)</nobr>
        </th>
        <th>
            <nobr>F116a: Water<br/> disconnected</nobr>
        </th>
        <th>
            <nobr>F116b: Electricity <br/>disconnected</nobr>
        </th>
        <th>
            <nobr>F117: Sleeping<br/> rooms</nobr>
        </th>
        <th>
            <nobr>F118: Cooking<br/> fuel type</nobr>
        </th>
        <th>
            <nobr>F119: Main material <br/>house walls</nobr>
        </th>
        <th>
            <nobr>F120: Tenure <br/>stands</nobr>
        </th>
        <th>
            <nobr>F121: HH <br/>posessions</nobr>
        </th>
        <th>Score</th>
    </tr>
