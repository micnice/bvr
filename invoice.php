...
$strSQL = "SELECT usage,shortname,price,sum(amount) as totalamount,count(*) as claims"
...
<?php
    ...
    $cboSQL = "select count(*) qnumber,sum(q1+q2+q3+q4+q5+q6) cboscore from cboscore "
 ...
 ?>
        <tr>
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Payments Due to Quantity (Claims) </td>
           <td align="right"><?php echo number_format($totalamount,2,'.',','); ?> </td>
        </tr>
        <tr style="background-color: #e5e5e5">
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quality Score </td>
           <td align="right"><?php echo number_format($totalquality,2,'.',','); ?>% </td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Client Satisfaction Score </td>
           <td align="right"><?php echo number_format($cbototal,2,'.',','); ?>%</td>
        </tr>
        <tr style="background-color: #e5e5e5">
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Overal Quality Score </td>
           <td align="right"><?php echo number_format($overallquality,2,'.',','); ?>% </td>
        </tr>
        <tr>
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quality Payment </td>
           <td align="right"><?php echo number_format($qualitypayment,2,'.',','); ?> </td>
        </tr>
        <tr style="background-color: #e5e5e5">
            <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grand Total Payment </td>
           <td align="right"><?php echo number_format($totalamount+$qualitypayment,2,'.',','); ?> </td>
        </tr>
 <?php
   pg_close($conn);
  ?>
