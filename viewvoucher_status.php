...
$sqlbeneficiary = pg_query(
    $conn,
    "select firstname, surname from beneficiarymaster where nationalid='$nationalid'"
);
$beneficiary = pg_fetch_row($sqlbeneficiary);
?>
<table style="margin:auto;">
    <tr>
        <td colspan="7"><em><?php echo $beneficiary[0].' '.$beneficiary[1]
                .', ID Number: '.$nationalid; ?></em></td>
    </tr>
  ...
  $sql = pg_query(
      $conn,
      "SELECT a.vouchertype,c.shortname,b.facilityname,a.redeemserial,a.idredeemedvouchers,a.claimserial,a.distributorno,a.periodid,a.claimed,d.monthname,d.yearname from REDEEMEDVOUCHERS a,FACILITY b, VOUCHERTYPE c, PERIOD d where "
