...
if($vserial==0){
    $strSQL = "SELECT idvoucherclaims,voucherserial,patientid,serviceoffered,amount,facilityname,shortname,firstname,surname,ref,vouchertype"
    ...
    $strSQL = "SELECT idvoucherclaims,voucherserial,patientid,serviceoffered,amount,facilityname,shortname,firstname,surname,ref"
          . " From voucherclaims,facility, vouchertype,beneficiarymaster  where approval='yes' and distributorno=idfacility and usage=vouchertype"
