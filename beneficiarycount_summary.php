...
$strSQL1
    = "select 'Nkulumane District' district,monthname,yearname,monthcode,count(distinct nationalid) beneficiaries from redeemedvouchers a,period b "
...
$strSQL2
    = "select 'Harare South District' district,monthname,yearname,monthcode,count(distinct nationalid) beneficiaries from redeemedvouchers a,period b "
