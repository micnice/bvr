...
if ($vserial == 1) {
  $strRedeem
      = "SELECT redeemserial,nationalid,facilityname,shortname,claimed,claimserial,periodid,distributorno,usage,idredeemedvouchers,finalredeem"
...
<table>
  ...
  for ($i = 0; $i < $numrowsRedeem; $i++) {
    ...
    $strSQL
        = "SELECT approval,ref From voucherclaims where vouchertype=$vouchertype and voucherserial='$redeemserial'";
    //echo $strSQL.'<br />';
    ...
    ?>
      <tr>
          <td>
              <a href="editRedeem.php&redeemserial=<?php echo $redeemserial; ?>&vouchertype=<?php echo $vouchertype; ?>"><?php echo $redeemserial; ?></a>
          </td>
              ...
              if ($finalredeem == 1) {
                ...
                ?>
                  <form action="claimadd.php" method="POST">
                      ...
                      <input type="hidden" name="redeemserial"
                             value="<?php echo $redeemserial; ?>">
                      <input type="hidden" name="claimserial"
                  ...
                  <form action="revokevoucher_confirm.php" method="POST">
                      <input type="hidden" name="idredeemedvoucher"
                             value="<?php echo $idredeemedvouchers; ?>">
                      ...
                      <input type="hidden" name="name"
                             value="<?php echo $firstname.' '.$surname; ?>">
  ...
  if ($numrowsRedeem == 0) {
    ...
    $strVoucherSales
        = "SELECT voucherserial,a.nationalid,facilityname,distributorno,firstname,surname"
