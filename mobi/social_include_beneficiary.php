        <tr class="lime">
            ...
            <td colspan="3">
                ...
                <input type="hidden" name="nationalid" id="nationalid" value="<?php echo trim($nationalid); ?>"><?php echo trim($nationalid); ?> 
                <?php
                }
                ?>
        ...
        <tr class="lime">
            ...
            <td><font size="4">LMP:</font><input type="text" size="11" maxlength="11" name="lmp" value="<?php echo trim($lmp); ?>" id="lmp" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" placeholder="dd/mm/yyyy" onblur="getEdd()" required></td>
        ...
        <tr class="lime">
            ...
            <td><input type="text" size="30" maxlength="50" value="<?php echo trim($guardian); ?>" name="guardian"></td>
            <td><font size="4">Marital Status:</font></td>
            <td><input type="text" size="40" maxlength="40" value="<?php echo trim($maritalstatus); ?>" name="maritalstatus"> </td>
        </tr>
        <tr class="lime">
            <td><font size="4">Parity:</font></td>
            <td colspan="3"><input type="text" size="30" maxlength="50" value="<?php echo trim($parity); ?>" name="parity"></td>
        </tr>
        <tr class="lime">
            <td><font size="4">Location:</font></td>
            <td><input type="text" size="30" maxlength="50" value="<?php echo trim($location); ?>" name="location"></td>
            <td><font size="4">Village:</font></td>
            <td><input type="text" size="40" maxlength="40" value="<?php echo trim($village); ?>" name="village"> </td>
        </tr>
        <tr class="lime">
            <td><font size="4">Certificate of Eligibility:</font></td>
            <td><input type="text" size="30" maxlength="50" value="<?php echo trim($serialno); ?>" name="serialno"></td>
            <td><font size="4">Phone:</font></td>
            <td><input type="text" size="40" maxlength="40" value="<?php echo trim($phone); ?>" name="phone"> </td>
        </tr>
        <tr class="lime">
            <td><font size="4">Postal Address:</font></td>
            <td colspan="3"><input type="text" size="50" maxlength="50" value="<?php echo trim($postaladdress); ?>" name="postaladdress"></td>
        ...
        <tr class="lime">
            ...
            <td><select name="city" id="city" required>
                   ...
                   <option value="Harare" <?php if(strcmp($city,'Harare')==0){ echo 'selected'; } ?>>Harare</option> 
                   <option value="Bulawayo" <?php if(strcmp($city,'Bulawayo')==0){ echo 'selected'; } ?>>Bulawayo</option> 
                </select>
            </td>
            <td></td>
            <td> </td>
