...
if($vserial==0){
    $strSQL = "SELECT idvoucherclaims,claimdate,voucherserial,patientid,serviceoffered,amount,facilityname,shortname,rejectshortname,firstname,surname,ref"
          . " From voucherclaims,facility, vouchertype,rejectreasons,beneficiarymaster where idreason=rejectreason and  approval='no' and distributorno=idfacility and usage=vouchertype"
