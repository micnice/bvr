...
$strSQL
    = "SELECT * From beneficiarymaster where (lower(firstname) like '%$firstname%' and lower(surname) like '%$surname%') or (lower(firstname) like '%$surname%' and lower(surname) like '%$firstname%') limit 100";
  ...
  for ($i = 0; $i < $numrows; $i++) {
    ...
    ?>
      <tr>
          ...
          <td>
              <a href="../nationalid_edit.php?source=mobi&nationalid=<?php echo trim(
                  $row["nationalid"]
              ); ?>">Edit</a></td>
