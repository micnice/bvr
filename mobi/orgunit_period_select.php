<table  style="margin:auto auto;background-color: #E0F277;width: 400px">
        <tr>
            ...
            <td><?php
                ...
                if(strcmp($userrole, "admin")==0){
                    ...
                    $sql = pg_query($conn,"SELECT monthcode,monthname,yearname FROM period where monthname='".date('F')."' and yearname=".date('Y'));
                }
        ...
        <tr>
            ...
            <td> <select name="distributor" id="distributor" required>
                ...
                if(strcmp($userrole, "admin")==0){
                    ...
                    $sql = pg_query($conn,"SELECT idfacility,facilityname FROM facility where idfacility=".$_SESSION['facility']."");
                }
                while ($row = pg_fetch_assoc($sql)) {
 ...
 <tr><td colspan="2" align="center"><input type="submit" value="Verify / Redeem"></td></tr>
</table>
</div>