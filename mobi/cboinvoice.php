    ...
    <table width="<?php echo $tablewidth; ?>">
        ...
        <tr>
            <td colspan="8">
                ...
                <div class="table">
                    <div class="row">
                        <div class="column"><h3>Period:</h3></div>
                        <div class="column"><h3>
                                <u><?php echo $periodname; ?></u></h3></div>
                    </div>
                    <div class="row">
                        <div class="column"><h3>CBO:</h3></div>
                        <div class="column"><h3><u><?php echo $cbo; ?></u></h3>
                        </div>
                    </div>
                    <div class="row">
                        <div class="column"><h3>Facility:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h3>
                        </div>
                        <div class="column"><h3><u><?php echo $orgunit; ?></u>
                            </h3></div>
                    </div>
                </div>
            </td>
        ...
        <tr>
            ...
            <td style="text-align:right;"><?php echo $row1["qnumber"]
                  + $row2["qnumber"] + $row3["qnumber"]; ?></td>
            <td rowspan="2"><?php echo $row1["minserial"].' - '
                  .$row1["maxserial"]; ?></td>
            <td rowspan="2"><?php echo $row2["minserial"].' - '
                  .$row2["maxserial"]; ?></td>
            <td rowspan="2"><?php echo $row3["minserial"].' - '
                  .$row3["maxserial"]; ?></td>
        ...
        <tr>
            <td>Number of completed <br/>questionnaires submitted<br/>timely
            </td>
        ...
        <tr style="background-color:#D0D0D0">
            <td style="text-align:right;" colspan="7"><b>Grand Total Earned:</b>
            </td>
            <td style="text-align:right;"><b>$<?php echo number_format(
                    $total1 + $total2,
                    2,
                    '.',
                    ','
