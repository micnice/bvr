...
$username = $_SESSION['username'];
    ...
    $sql1 = pg_query($conn,"SELECT facilityname From facility where idfacility='$refer_to'");
    $row2 = pg_fetch_row($sql1);
    $referto_name = $row2[0];
    
    $sql1 = pg_query($conn,"SELECT facilityname From facility where idfacility='$ambulanceid'");
    $row2 = pg_fetch_row($sql1);
    $ambulance = $row2[0];
...
<table style="margin:auto 0;">
            ...
            <tr>
                <td><font style="color:#537313">Referring Facility:</font></td><td><?php echo $facilityname; ?></td>
            </tr>
            <tr>
                <td><font style="color:#537313">Referring To:</font></td><td><?php echo $referto_name; ?></td>
            </tr>
            <tr>
                <td><font style="color:#537313">Ambulance:</font></td><td><?php echo $ambulance; ?></td>
            </tr>
            <tr>
                <td><font style="color:#537313">Referral Reason:</font></td><td><?php echo $reason; ?></td>
            </tr>
...
<?php
    ...
    $query = "insert into referrals (nationalid,referralnumber,reason,facilityfrom,facilityto,ambulance,calltime,addedby) "
             . "values('$nationalid',$referralnumber,'$reason',$distributor,$refer_to,$ambulanceid,'".date('d-m-Y h:i')."','$username')";
