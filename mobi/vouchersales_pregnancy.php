...
?>
<?php
    $query = "UPDATE beneficiarymaster SET pregnancy=$pregnancy where lower(trim(nationalid))=lower(trim('$nationalid'))";
    //echo '<br />'.$query.'<br />';
...
pg_close();
?>
<h3 style="text-align: center; color: green;">Second Pregnancy Activation Succssful</h3>
