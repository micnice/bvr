...
<div align="center">
  ...
  $sql = pg_query(
      $conn,
      "SELECT * From referrals where nationalid='$nationalid'"
  );
  ...
  if ($count == 0) {
    echo "<div align='center'><br /><br />Beneficiary with National ID <em>"
        .$nationalid
        ."</em> does not exist!<br /><a href='verifyvoucher.php'>Try Again</a></div> <br /><br />";
    include "footer.php";
    exit();
        ...
        <form action="referral_process.php" method="POST">
            ...
            <table border="0">
                <tr>
                    ...
                    <td><textarea rows="4" cols="25" name="reason"
                    ...
                    <td>
                        <select name="ambulance" required>
                          ...
                          if (in_array(
                            ...
                            ?>
                              <option value="19">Bulawayo City Ambulance
                              </option>
                    ...
                    <td>
                      ...
                      ?>
                        <input type="hidden" name="refer_to"
                               value="<?php echo $refer_to; ?>">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        <div align="center"><input type="submit"
                                                   value="Generate Referral Note">
                        </div>
                    </td>
                </tr>
