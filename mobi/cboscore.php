...
if (strlen($serialno) == 1) {
  $strSQL
      = "select coalesce(max(substring(serialno,3)),'0') from cboscore where serialno like 'QS%'";
  $result = pg_exec($conn, $strSQL);
  $row = pg_fetch_row($result);

  $uniquenumber = (int)$row[0];
...
$cbo = pg_query(
    $conn,
    "SELECT * FROM CBOSCORE WHERE periodid=$monthcode AND facilityid=$orgunitid AND serialno='$serialno'"
);
$q1 = 0;
$q2 = 0;
$q3 = 0;
        ...
        <table style="background-color:#E0F277;">
            <tr>
                <td colspan="4"
                  ...
                  <?php echo 'Organisation Unit: <strong>'.$orgunit
                      .'</strong> Period: <strong>'.$period.'</strong>'; ?><br/><br/>
                    CBO Questionnaire Serial Number:
                    <strong><?php echo $serialno; ?></strong>
                </td>
            </tr>
            <tr>
                <td colspan="4"
                    style="background-image: url(images/green_bg.png);"><strong>CUSTOMER
                        SATISFACTION INDICATORS</strong></td>
            <tr>
                <td></td>
            ...
            <tr>
                <td>1</td>
                <td>How were you received by the staff at the health facility?
                </td>
                <td style="text-align: center;">10</td>
                <td>
                    <select name="q1">
                        <option value=""></option>
                        <option value="10" <?php echo $q1a; ?>>10 - Friendly
                        </option>
                        <option value="5" <?php echo $q1b; ?>>5 - Normal
                        </option>
                ...
                <td>
                    <nobr>
                        <input type="text" name="hours" size="4"
                               value="<?php echo $hours; ?>"/> Hrs
                        <input type="text" name="minutes" size="4"
                               value="<?php echo $minutes; ?>"/> Mins
                    </nobr>
                </td>
            </tr>
            <tr>
                <td>a</td>
                <td>How do you judge the time that you waited before being
                    helped?
                </td>
                ...
                <td>
                    <select name="q2">
                        <option value=""></option>
                        <option value="5" <?php echo $q2a; ?>>5 - Reasonable
                        </option>
                        <option value="0" <?php echo $q2b; ?>>0 - Too Long
                        </option>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td>3</td>
                <td>Were the medicines prescribed for you available at the
                    health facility?
                </td>
                <td style="text-align: center;">10</td>
                <td>
                    <select name="q3">
                        ...
                        <option value="5" <?php echo $q3b; ?>>5 - Partly
                        </option>
            ...
            <tr>
                ...
                <td>
                    <select name="q5">
                        <option value=""></option>
                        <option value="5" <?php echo $q5a; ?>>5 - Reasonable
                        </option>
                        <option value="0" <?php echo $q5b; ?>>0 - Unaffordable
                        </option>
                    </select></td>
            </tr>
            <tr>
                <td>6</td>
                <td>Were you satisfied with the services that you were
                    offered?
                </td>
                <td style="text-align: center;">10</td>
                <td>
                    <select name="q6">
                        <option value=""></option>
                        <option value="10" <?php echo $q6a; ?>>10 - Very
                            Satisfied
                        </option>
                        <option value="5" <?php echo $q6b; ?>>5 - Satisfied
                        </option>
                        <option value="0" <?php echo $q6c; ?>>0 - Dissatisfied
                        </option>
                    </select></td>
            </tr>
            <tr>
                <td style="vertical-align:top">7</td>
                <td style="vertical-align:top">Do you have any comments or
                    suggestions for the improvement of the services?
                </td>
                <td style="text-align: center;"></td>
                <td>
