...
<form action="cbosamples.php" method="POST">
<div align="center"><h3>View CBO Samples</h3><br />
                ...
                <tr>
                    ...
                    <td> <select name="distributor" id="distributor">
                        ...
                        if(strcmp($userrole, 'admin')==0){
                            ...
                            $sql = pg_query($conn,"SELECT idfacility,facilityname FROM facility where cbo='$cbo' order by facilityname asc");
                        }
