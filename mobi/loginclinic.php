<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.0//EN" "http://www.wapforum.org/DTD/xhtml-mobile10.dtd">
        ...
        if(strcmp($_SESSION['login'], 'false')==0){
            ...
            $query = "SELECT * FROM users WHERE username = '$username' AND password = md5('$password') and userrole in ('clinic','CBO','admin','hospital','ambulance','social','matron','sic');";
            //echo $query;
...
<hr />
    ...
    ?>
            ...
            <a href="partially_redeemed_form.php">Partially Redeemed Vouchers</a><br /><br />
    ...
    if(in_array($role,$acl)){ 
    ?>
            <a href="social_vouchersales_form.php">Assessment & Voucher Sales</a><br /><br />
