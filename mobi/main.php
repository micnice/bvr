            ...
            ?>
              ...
              <div class="submenu">
                  <ul>
                      ...
                      <li id="AddClaim"><a
                                  href="main.php?page=trackvouchers_form">Track
                              Vouchers</a></li>
                      <li id="AddClaim"><a href="main.php?page=claimadd_form">View
                              Redeemed Vouchers</a></li>
                      <li id="AddClaim"><a
                                  href="main.php?page=revokevoucher_form">Vouchers
                              Redeemed by ID</a></li>
              ...
              <div class="submenu">
                  <ul>
                      <li id="QualityChecklist"><a
                              ...
                              Checklist</a></li>
                      <li id="CBOScore"><a href="main.php?page=cboscore_form">CBO
                              Score</a></li>
                      <li id="CBOScore"><a
                                  href="main.php?page=viewcboquestionnaires_form">Audit
                              CBO Scores</a></li>
                      <li id="CBOScore"><a
                                  href="main.php?page=cboscore_summary_form">CBO
                              Score Summary</a></li>
                      <li id="CBOScore"><a
                                  href="main.php?page=quality_summary_form">Quality
                              Score Summary</a></li>
                      <hr/>
                      <li id="Summary"><a href="cbosamples_form.php"
              ...
              <div class="submenu">
                  <ul>
                      ...
                      <li id="Summary"><a href="voucherredeemedsummary_form.php"
                                          onclick="return !window.open(this.href, 'Google', 'width=1200,height=700')"
                                          target="_blank">Summary of Vouchers
                              Redeemed</a></li>
                      ...
                      <li id="Summary"><a
                                  ...
                                  onclick="return !window.open(this.href, 'Google', 'width=1200,height=700')"
                                  target="_blank">Summary of Vouchers Awaiting
                              Approval</a></li>
                      ...
                      <li id="ListClaims"><a href="claimsapproved_form.php"
                                             onclick="return !window.open(this.href, 'Google', 'width=1200,height=700')"
                                             target="_blank">List of Approved
                              Claims</a></li>
                      <li id="RejectedClaims"><a
                                  href="main.php?page=claimsrejected_form">List
                              of Rejected Claims</a></li>
