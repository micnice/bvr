...
$query
    = "select facilityname,monthname,yearname,sum(q1+q2+q3+q4+q5+q6) score from cboscore a,period b,facility c "
...
<table style="border: 1px;">
    ...
    <tr>
        <td>Serial No.</td>
        <td><em style='color:red'><?php echo $serialno; ?></em></td>
    </tr>
    <tr>
        <td>Facility</td>
