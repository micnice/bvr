...
$strSQL
    ...
    ."b.distributorno=a.idfacility and a.idfacility=".$_SESSION['facility']
    ." group by facilityname,substring(saledate,7,4),substring(saledate,4,2) order by facilityname,substring(saledate,7,4),substring(saledate,4,2)";
