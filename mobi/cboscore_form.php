...
<form action="cboscore.php" method="POST">
    <div align="center"><h3>CBO Score</h3><br/>
        <table style="background-color: #E0F277;">
            ...
            <tr>
                ...
                <td><select name="distributor" id="distributor">
                    ...
                    if (strcmp($userrole, 'admin') == 0) {
                      ...
                      $sql = pg_query(
                          $conn,
                          "SELECT idfacility,facilityname FROM facility where cbo='$cbo'"
                      );
                    }
            ...
            <tr>
                <td><font size="4">Questionnaire Serial Number</font><br/><font
                            size="2">
                        UnKnown: <input type="radio"
                                        onclick="javascript:UnknownCheck();"
                ...
                <td>
                    ...
                    <div id="UnknownCheck" style="display:none">
                        <input type="hidden" size="20" name="serialno"
                               id="unknownSerial" value="0"/>
                        <em>To be auto-generated!</em>
                    </div>
                    <div id="KnownCheck" style="display:block">
                        <input type="text" size="20" name="serialno"
                               id="knownSerial" required/>
                    </div>
                </td>
            </tr>
            <tr>
