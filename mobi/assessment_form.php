...
<body>
<form action="social_vouchersales_search.php" method="POST" id='searchform'>
    <h3>Beneficiary Assessment and Voucher Sales</h3>
    <div>
        <em>Search using a combination of Firstname and Surname OR with just ID
            number</em>
