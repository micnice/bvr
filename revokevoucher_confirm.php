...
?>
 <br /><table style="margin:auto;">
     <tr>
         <td colspan="2"><h3>Confirm??</h3>Are you sure you want to revoke the voucher with the following details:</td>
        </tr>   
     <tr>
            <td>National ID:</td>
        ...
        <tr>
            <td colspan="2">
                ...
                <input type="hidden" name="voucherserial" value="<?php echo $voucherserial; ?>">
