...
$strSQL = "select idredeemedvouchers,redeemdate from redeemedvouchers where length(trim(redeemdate))<10 and length(trim(redeemdate))>4";
//echo $strSQL;
...
for ($i = 0; $i < $numrows; $i++) {
    ...
    $query = "UPDATE redeemedvouchers set periodid=$period,redeemdate='$newRedeemdate' where idredeemedvouchers=$idRedeem";
