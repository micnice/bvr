   ...
   for($i = 0; $i < $numrows; $i++) {
    ...
    ?>
        <tr>
           ...
           <td><a href="province_manage_form.php?id=<?php echo $row["idprovince"]; ?>&action=edit&name=<?php echo $row["provincename"]; ?>">Edit</a> </td>
        </tr>
<?php
  }
   pg_close($conn);
  ?>
        <tr>
           <td></td>
           <td><a href="province_manage_form.php?action=new&name=new&id=new">Add New</a> </td>
        </tr>
</table>
