...
if(trim($q2hrs)==''){$q2hrs='null';}
if(trim($q2mins)==''){$q2mins='null';}

$username = $_SESSION['username'];
$dateadded = date('d/m/Y');

if(strcmp($update,'no')==0){
    $query = "INSERT INTO cboscore(q1,q2,q3,q4,q5,q6,serialno,periodid,facilityid,hours,minutes,comment,addedby,dateadded) "
            . " VALUES ($q1,$q2,$q3,$q4,$q5,$q6,'$serialno',$period,$orgunitid,$q2mins,$q2hrs,'$comment','$username','$dateadded')"; 
}else{
    $query = "update cboscore set q1=$q1,q2=$q2,q3=$q3,q4=$q4,q5=$q5,q6=$q6,hours=$q2hrs,minutes=$q2mins,comment='$comment'"
...
?>
<form action="mobi/cboscore.php" method="POST">
