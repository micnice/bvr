...
<html>
    ...
    <body>
        ...
        if($filteron==0){
            $strSQL = "select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd,'Delivered' as status from beneficiarymaster a,vouchersales b,facility c "
                . " where a.nationalid = b.nationalid and b.distributorno = c.idfacility and substring(a.edd,4,7) = '$period' and city='$district' and "
                . " b.voucherserial in (select redeemserial from redeemedvouchers where vouchertype in (6,5,7,9,16)) "
                . " UNION select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd,'Pending' as status from beneficiarymaster a,vouchersales b,facility c "
                . " where a.nationalid = b.nationalid and b.distributorno = c.idfacility and substring(a.edd,4,7) = '$period' and city='$district' and "
                . " b.voucherserial not in (select redeemserial from redeemedvouchers where vouchertype in (6,5,7,9,16))";
        }else{
            $strSQL = "select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd, 'Delivered' as status from beneficiarymaster a,vouchersales b,facility c "
                . " where a.nationalid = b.nationalid and b.distributorno = c.idfacility and substring(a.edd,4,7) = '$period' and city='$district' and "
                . " b.voucherserial in (select redeemserial from redeemedvouchers where vouchertype in (6,5,7,9,16)) and b.voucherserial=$voucherserial "
                . " UNION select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd, 'Pending' as status from beneficiarymaster a,vouchersales b,facility c "
                . " where a.nationalid = b.nationalid and b.distributorno = c.idfacility and substring(a.edd,4,7) = '$period' and city='$district' and "
        ...
        <h3 style="text-align: center">Delivery Tracker</h3>
        <table>
            <tr><td colspan="19">
                    <div align="left">
    <form action="deliverytracker.php" method="POST">
        ...
        <input type="submit" value="Search">
            ...
            for ($i = 0; $i < $numrows; $i++) {
                ...
                $row = pg_fetch_array($result, $i);
                    ...
                    $redeemserial = $row["voucherserial"];
                    $sqlRedeem = "select redeemdate from redeemedvouchers"
                        . " where redeemserial = $redeemserial and vouchertype in (6,5,7,9,16)";
                ...
                $edddate = date('Y-m-d', strtotime($edd));
                    ...
                    if ($i % 2 == 0) {
                        ...
                        <tr style="vertical-align:top">
                            <td style="background-color: <?php echo $color; ?>"><?php echo $row["edd"]; ?> </td>
                            <td style="background-color: <?php echo $color; ?>"><?php echo $row["saledate"]; ?> </td>
                            <td style="background-color: <?php echo $color; ?>"><?php echo $redeemDate; ?> </td>
                            ...
                            <td style="background-color: <?php echo $color; ?>"><?php echo $row["location"] . ', ' . $row["village"]; ?> </td>
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $row["phone"]; ?> </nobr></td>
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $row["lmp"]; ?> </nobr></td>
                            <td style="background-color: <?php echo $color; ?>"><nobr><?php echo $weeks; ?> </nobr></td>
            ...
            $redeemDate=" ";
            ?>
            <td style="background-color: <?php echo $color; ?>"><?php echo $row["status"]; ?> </td>
