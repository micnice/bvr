...
if ($filteron == 0) {
  $strSQL
      = "select b.saledate,b.voucherserial,c.facilityname,a.firstname,a.surname,a.nationalid,a.phone,a.location,a.village,a.lmp,a.edd,'Delivered' as status from beneficiarymaster a,vouchersales b,facility c "
