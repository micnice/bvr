...
if($vserial==1){
    $strSQL = "select a.firstname,a.surname,a.nationalid,a.location,b.voucherserial,b.saledate,a.serialno,a.phone,b.distributorno,c.facilityname from beneficiarymaster a, vouchersales b, facility c where "
   ...
   for($i = 0; $i < $numrows; $i++) {
    ...
    ?>
        <tr>
           ...
           <td> <form action="main.php?page=vouchersales" method="POST">
