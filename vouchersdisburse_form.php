...
<body>
    ...
    <div align="center"><h3>Disburse Vouchers</h3><br /><table  style="background-color: #E0F277;">
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" size="30" maxlength="50" name="startserial"> </td>
        </tr>
        <tr>
            <td><font size="4">End Serial No. :</font></td>
            <td><input type="text" size="20" maxlength="20" name="endserial"> </td>
        </tr>
        <tr>
            <td><font size="4">Collected By. :</font></td>
            <td><input type="text" size="20" maxlength="20" name="collectedby"> </td>
        </tr>
        <tr>
            <td><font size="4">Date Collected. :</font></td>
            <td><input type="text" size="20" maxlength="20" name="datecollected"> </td>
        </tr>
    </table>
    </div><p align="center">
