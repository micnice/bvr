...
//$period=$_POST['period'];
    ...
    $strSQL = "select a.usage,a.shortname,b.amount,count(*) from vouchertype a,voucherclaims b"
            . " where a.usage=b.vouchertype and b.distributorno=$distributor and b.approval='no' group by a.usage,a.shortname,b.amount order by a.usage";
...
?>
    ...
    <h3 style="text-align: center">Summary of Rejected Vouchers<br /><br />
...
<?php
  ...
  ?>
    ...
    <div style="text-align: center"><a href="voucherrejectedsummary.php">Voucher Redeemed Summary</a></div>
</body>
</html>