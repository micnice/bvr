...
//$period=$_POST['period'];
    ...
    $strSQL = "select b.vouchertype,a.shortname,a.price,count(*) from vouchertype a,redeemedvouchers b"
...
<?php
  ...
  ?>
    ...
    <div style="text-align: center"><a href="voucherredeemedsummary.php">Voucher Redeemed Summary</a></div>
</body>
</html>