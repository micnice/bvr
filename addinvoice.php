...
<form method="POST">
    <div align="center"><h3>Enter Invoices</h3><br/>
        <table style="background-color: #E0F277;">
            <tr>
                <td><font size="4">Invoice Number</font></td>
                <td><input type="text" size="30" maxlength="60" name="invoiceno"
                           required></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="number" size="10" maxlength="10" name="amount"
                           required></td>
            </tr>
        </table>
    </div>
...
<c:if test="${pageContext.request.method=='POST'}">
    <c:catch var="exception">
        <sql:update dataSource="${bvr}" var="updatedTable">
            insert into facilityinvoice
            (idfacility,invoicedate,invoicenumber,amount)
