...
<table  style="background-color: #E0F277;">
        <tr>
            ...
            <td> <select name="period" id="period" required>
                ...
                $sql = pg_query($conn,"SELECT monthcode,monthname,yearname FROM period order by monthcode asc");
                ...
                //pg_close($conn);
                $periodname = htmlspecialchars($row['monthname'])." ".htmlspecialchars($row['yearname']);
