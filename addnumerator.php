...
<form method="POST">
    <div align="center"><h3>Add Numerator</h3><br/>
        <table style="background-color: #E0F277;">
            ...
            <tr>
                ...
                <td><input type="text" size="20" maxlength="20" name="address">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" size="30" maxlength="30" name="email">
                </td>
            </tr>
            <tr>
                <td><font size="4">Phone Number:</font></td>
                <td><input type="text" size="20" maxlength="20" name="phone">
                </td>
            </tr>
        </table>
    </div>
...
<c:if test="${pageContext.request.method=='POST'}">
    <c:catch var="exception">
        <sql:update dataSource="${bvr}" var="updatedTable">
            ...
            (firstname,surname,address,nationalid,email,phone)
            values(?,?,?,?,?,?);
