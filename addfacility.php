...
<form method="POST">
    <div align="center"><h3>Add/Edit Facility</h3><br/>
        <table style="background-color: #E0F277;">
            ...
            <tr>
                ...
                <td><input type="text" size="60" maxlength="60" name="address">
                </td>
            </tr>
            <tr>
                <td><font size="4">Phone:</font></td>
                <td><input type="text" size="30" maxlength="50" name="phone">
                </td>
            </tr>
            <tr>
...
<c:if test="${pageContext.request.method=='POST'}">
    <c:catch var="exception">
        <sql:update dataSource="${bvr}" var="updatedTable">
            ...
            (facilityname,address,phone,contactperson,iddistrict)
