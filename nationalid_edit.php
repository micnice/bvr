...
<div style="margin: auto">
    ...
    <table>
        <tr>
            <td>Old National ID</td><td><input type="hidden" name="oldnationalid" value="<?php echo $nationalid; ?>"><?php echo $nationalid; ?></td>
        </tr>
        <tr>
            <td>New National ID</td><td><input type="text" name="newnationalid" value=""></td>
        </tr>
        <tr>
