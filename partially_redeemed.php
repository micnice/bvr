...
if((!isset($period) || empty($period)) && $vserial==0){
   ...
   if($vserial==0){
    $strSQL = "select a.redeemserial,a.claimserial,a.nationalid,a.vouchertype,a.redeemdate,a.periodid,a.distributorno,b.firstname,b.surname,b.phone,a.idredeemedvouchers "
...
<div align="center">
    <form action="main.php" method="GET">
        ...
        <input type="hidden" name="page" value="partially_redeemed">
