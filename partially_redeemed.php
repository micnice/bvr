...
if ($vserial == 0) {
  $strSQL
      = "select a.redeemserial,a.claimserial,a.nationalid,a.vouchertype,a.redeemdate,a.periodid,a.distributorno,b.firstname,b.surname,b.phone,a.idredeemedvouchers "
