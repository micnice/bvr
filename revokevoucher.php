...
<table style="margin:auto;">
    <tr>
        <td colspan="8"><em><?php echo $beneficiary[0].' '.$beneficiary[1]
  ...
  $sql = pg_query(
      $conn,
      "SELECT a.vouchertype,c.shortname,b.facilityname,a.redeemserial,a.idredeemedvouchers,a.claimserial,a.distributorno,a.periodid,a.claimed,d.monthname,d.yearname,a.ref from REDEEMEDVOUCHERS a,FACILITY b, VOUCHERTYPE c, PERIOD d where "
